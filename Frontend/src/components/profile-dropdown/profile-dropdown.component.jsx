    ...
    render() {
        ...
        return (
            <div className='profile-container'>
                <Badge className='profile-badge' count={99}>
                    <Dropdown className='dropdown-box'>
                        <Dropdown.Toggle variant="light" id="profile-dropdown">
                            <img src={process.env.PUBLIC_URL + '/profile.jpg'} alt="mdo" width="50" height="50" class="rounded-circle" />
                        ...
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item href="#action/3.3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
